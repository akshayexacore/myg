      ...
      body: Stack(
        children: [
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    gapHC(31),
                    if (_profileController.user.value.grade
                            .hasPermission(Permission.newClaim) ||
                        _profileController.user.value.grade
                            .hasPermission(Permission.requestAdvance))
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Expanded(
                            child: _profileController.user.value.grade
                                    .hasPermission(Permission.newClaim)
                                ? Bounce(
                          ...
                          Expanded(
                              child: _profileController.user.value.grade
                                  ...
                                  ? Bounce(
                                      ...
                                      onTap: () {
                                        Get.toNamed(
                                            AdvanceRequestListPage.routeName);
                                      },
                                      child: menuCard(
                                          0.0,
                                          30.0,
                    ...
                    if (_profileController.user.value.grade
                      ...
                      gapHC(20),
                    if (_profileController.user.value.grade
                            .hasPermission(Permission.drafts) ||
                        _profileController.user.value.grade
                    ...
                    if (_profileController.user.value.grade
                            .hasPermission(Permission.claimApprovals) ||
                        _profileController.user.value.grade
                            .hasPermission(Permission.advanceApprovals))
                      gapHC(20),
                    if (_profileController.user.value.grade
                            .hasPermission(Permission.claimApprovals) ||
                        _profileController.user.value.grade
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: _profileController.user.value.grade
                                ...
                                ? Bounce(
                                    ...
                                    onTap: () {
                                      Get.toNamed(
                                          ClaimApprovalListPage.routeName);
                                    },
                                    child: menuCard(
                                        _profileController.user.value.grade
                                                .hasPermission(
                          ...
                          Expanded(
                            child: _profileController.user.value.grade
                                    .hasPermission(Permission.specialApprovals)
                                ? Bounce(
                                    duration: const Duration(milliseconds: 110),
                                    onTap: () {
                                      Get.toNamed(
                                          SpecialApprovalListPage.routeName);
                                    },
                                    child: menuCard(
                                        0.0,
                                        _profileController.user.value.grade
                    ...
                    if (_profileController.user.value.grade
                            .hasPermission(Permission.specialApprovals) ||
                        _profileController.user.value.grade
                            .hasPermission(Permission.cmdApprovals))
                      gapHC(20),
                    if (_profileController.user.value.grade
                            .hasPermission(Permission.specialApprovals) ||
                        _profileController.user.value.grade
          ...
          Align(
              ...
              child: Obx(
                () => Text(
                  _profileController.appVersion.value,
                  style: TextStyle(
                      fontSize: 11,
