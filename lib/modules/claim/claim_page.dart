  ...
  Widget build(BuildContext context) {
    return RawGestureDetector(
      ...
      child: SafeArea(
        child: WillPopScope(
          onWillPop: () async {
            return await claimController.showGetXBackConfirmation();
          },
          child: Scaffold(
                        ...
                        Obx(() {
                          ...
                          return DropDownTextField(
                            ...
                            onChanged: (selectedIds) {
                              debugPrint("ssssssssssss$selectedIds");
                              if (selectedIds != null &&
                                  selectedIds.isNotEmpty) {
                                final matchedBranches =
                                    landingController.branches
                                        .where(
                                          (branch) =>
                                              selectedIds.contains(branch.id),
                                        )
                                        .toList();

                                claimController.selectedBranch
                                  ..clear()
                                  ..addAll(matchedBranches);
                              } else {
                                // Clear the selection if selectedIds is null or empty
                                claimController.selectedBranch.clear();
                              }
                        ...
                        Obx(() {
                          ...
                          return ExpandedTileList.separated(
                            key: ValueKey(claimController.selectedCategories
                                ...
                                .join("")),
                            itemCount:
                                claimController.selectedCategories.length,
                            maxOpened: 1,
                            padding: EdgeInsets.zero,
