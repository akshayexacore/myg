              ...
              Padding(
                ...
                child: Column(
                  ...
                  gapHC(7),*/
                    headTitle(
                        "Amount",
                        "${_controller.claim.value!.categories!.expand((category) => category.items ?? []).toList().map((v) => v).toList().map(
                              (e) => e.amount,
                            ).toList().fold(0.0, (sum, item) => sum + item!.toDouble()).toStringAsFixed(2)} INR",
                        colors: primaryColor),
                  ],
                ),
              ),
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        ...
                                        child: ts(
                                            e.approverRemarks?.isNotEmpty==true
                                                ? e.approverRemarks
                                                : 'NA',
                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            children: [
                              CachedNetworkImage(
                                imageUrl: _controller.claim.value!
                              ...
                              tss(
                                  _controller
                                      .claim.value!.categories![index].name,
                                  Colors.black,
                                  15.0)
                            ],
                          ),
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        gapHC(10),
                                        headTitle("Amount",
                                            "${_controller.claim.value!.categories![index].items?[formIndex].amount ?? 0.toStringAsFixed(2)} INR"),
                                        Obx(() {
                                          if (_controller
                                                      .claim
                                                      .value!
