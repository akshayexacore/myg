                              ...
                              itemBuilder: (context, formIndex) {
                                return Column(
                                  children: [
                                    ...
                                    gapHC(10),
                                    if(_controller.claim.value!.categories![index].items[formIndex].status == ClaimStatus.resubmitted || _controller.claim.value!.categories![index].items[formIndex].status == ClaimStatus.pending)
                                    Row(
                                      children: [
                                        Expanded(
                                            child:Obx((){
                                        ...
                                        Expanded(
                                            child:AbsorbPointer(
                                              absorbing: !_controller.claim.value!.categories![index].items[formIndex].sentForApproval,
                                              child: Custombutton(
                                                  onTap:(){
                                                  ...
                                                  buttonColor: _controller.claim.value!.categories![index].items[formIndex].sentForApproval ? primaryColor : primaryColor.withOpacity(0.6),
