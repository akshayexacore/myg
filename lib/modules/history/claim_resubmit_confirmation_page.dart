                                        ...
                                        if (_controller
                                          ...
                                          if ((_controller
                                            ...
                                            return Padding(
                                              ...
                                              child: headTitle(
                                                "",
                                                "(Eligible amount ${max.toStringAsFixed(2)} INR ${_controller.reSubmittedCategories[index].hasStartMeter == true ? 'for $totalKms Kms @ ${_controller.reSubmittedCategories[index].items?[formIndex].selectedClass!.policy!.gradeAmount!} INR/Km' : ''})",
                                                colors: Colors.red,
                                              ),
                                            );
                                          }
