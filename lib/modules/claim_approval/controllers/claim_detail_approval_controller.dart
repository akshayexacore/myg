...
class ClaimDetailApprovalController extends GetxController
  ...
  void onChangeCheckBox(int catIndex, int itemIndex, bool val) {
    ...
    if (currentClaim != null) {
      ...
      final updatedItem = currentClaim.categories![catIndex].items?[itemIndex]
          .copyWith(isEnableSendApproval: val);

      // 2. Copy the items list and replace the updated item
      final updatedItems = [...currentClaim.categories![catIndex].items ??<ClaimFormData> []];
