...
class CsmCacheManager extends CacheManager with ImageCacheManager {
  static const key = 'libCachedImageData';

  static final CsmCacheManager _instance = CsmCacheManager._();

  factory CsmCacheManager() {
    return _instance;
  }

  CsmCacheManager._() : super(Config(key,maxNrOfCacheObjects: 300,fileService: CaFileService(maxAttempts: 3)));
}
