    ...
    children: [
      Container(
        ...
        transform: new Matrix4.translationValues(
            MediaQuery.of(context).size.width * upperContainerXaxis, -29.6, 0.0)
      ...
      Container(
        ...
        alignment: new Alignment(0, 0),
        transform: new Matrix4.translationValues(
            MediaQuery.of(context).size.width * bottomContainerXaxis,
            139.6,
            0.0)
          ..rotateZ(-27 * 3.1415927 / 180),
      ),
...
Widget backgroundwithouAppicon(
    context, bottomContainerXaxis, upperContainerXaxis, child) {
  return Stack(
    children: [
      Stack(
        children: [
          Container(
            ...
            alignment: new Alignment(0, 0),
            transform: new Matrix4.translationValues(
                MediaQuery.of(context).size.width * upperContainerXaxis,
                -29.6,
                0.0)
              ..rotateZ(-27 * 3.1415927 / 180),
          ),
                        ...
                        Bounce(
                          ...
                          child: badges.Badge(
                              ...
                              position: badges.BadgePosition.topEnd(
                                  top: -11, end: -2),
                              showBadge: Get.find<LandingController>()
                                          .notifications
                                          .value >
                                      0
                                  ? true
